...
function App() {
  ...
  return (
    <>
      ...
      <Tooltip title="Developer Links" placement="left">
        <Fab id="developer-links" onClick={() => window.open("https://drive.google.com/drive/u/4/folders/1b4HwESaGJ67riXSXOpiWLJ-lrR68G9cZ", "_blank")}>
